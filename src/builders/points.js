...
export function buildQuadsForPoints (points, vertex_data, vertex_template,
    { texcoord_index, position_index, shape_index, offset_index, pre_angle_index, angle2_index },
    { quad, quad_normalize, offset, pre_angle, angle, angle2, shape_w, texcoord_scale, texcoord_normalize }) {
    ...
    for (let p=0; p < num_points; p++) {
        ...
        for (let pos=0; pos < 4; pos++) {
            ...
            vertex_template[angle2_index] = angle2;
