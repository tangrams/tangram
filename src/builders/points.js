...
export function buildQuadsForPoints (points, vertex_data, vertex_template,
    { texcoord_index, position_index, shape_index, offset_index, pre_angle_index },
    { quad, quad_normalize, offset, pre_angle, angle, shape_w, texcoord_scale, texcoord_normalize }) {
