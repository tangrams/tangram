...
import { getYamlModule, getZipModule } from '../utils/modules';

// module references loaded either sync or async (depending on slim mode) via imported functions above
let jszip;
let yaml;
